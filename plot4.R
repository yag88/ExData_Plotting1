...
# prepare the frame for 4 graphs
par(mfrow = c(2, 2))
# plot the top left, same as plot2 
with(myabstract, plot(datetime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))

# plot the top right
with(myabstract, plot(datetime, Voltage, type = "l", ylab = "Voltage"))

#plot the bottom left, same as plot3
...
# and last the bottom right
with(myabstract, plot(datetime, Global_reactive_power, type = "l"))
